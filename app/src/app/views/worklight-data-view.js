...
class WorklightDataView extends LitElement {
  ...
  // eslint-disable-next-line class-methods-use-this
  showEntryDialog() {
    const dataEntryDialog = document.createElement('worklight-data-entry');
    document.querySelector('worklight-root').appendChild(dataEntryDialog);
    setTimeout(() => {
      dataEntryDialog
        .querySelector('.worklight-view-wrapper')
...
if (!customElements.get('worklight-data-view')) {
  customElements.define('worklight-data-view', WorklightDataView);
}
